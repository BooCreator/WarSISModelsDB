...
{
    public class Soldiers : ADataBase<Soldier>, IDataBaseElement<IRank>, IDataBaseRanks
    {
        public override string GetTableName() => TableName;
        public static String TableName => "Рядовые";

        public string PeopleName => People;
        public string DateName => Date;

        public static String People => "Человек";
        public static String Date => "Дата призыва";
