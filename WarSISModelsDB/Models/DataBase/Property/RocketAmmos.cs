...
{
    public class RocketAmmos : ADataBase<RocketAmmo>, IDataBaseProperties, IDataBaseElement<IProperty>
    {
        public override string GetTableName() => TableName;
        public static String TableName => "Ракетное оружие";
        ...
        public static String Cannons => "Тип снарядов";
