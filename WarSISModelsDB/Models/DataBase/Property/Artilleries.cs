...
{
    public class Artilleries : ADataBase<Artillery>, IDataBaseProperties, IDataBaseElement<IProperty>
    {
        public override string GetTableName() => TableName;
        public static String TableName => "Артиллерия";
        ...
        public static String Caliber => "Калибр";
        ...
        public static Dictionary<String, (Type, Int32)> Fields = new Dictionary<String, (Type, Int32)>()
        {
            ...
            { Caliber, (typeof(Int32), 0) },
            { Type, (typeof(String), 255) },
        };
