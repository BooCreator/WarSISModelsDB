...
{
    public class Branches : ADataBase<Branch>, IDataBaseSubdivisions, IDataBaseElement<ISubdivision>
    {
        public override string GetTableName() => TableName;
        public static String TableName => "Отделения";
        ...
        public static String Building => "Расположение";
